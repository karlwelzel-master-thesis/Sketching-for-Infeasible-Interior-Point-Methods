...
Neighbourhoods involving those bounds are known as \emph{short-step} IPMs and give better theoretical guarantees while having worse pratical performance~\cite[Chapter 5]{Wright-PrimalDualInteriorPointMethods}.
