...
\Cref{eqn:normal-equation} is called normal equation because it can be written as the normal equation of a least squares system with coefficient matrix \(\mat{D}\mat{A}^T\) if \(\vek{r}_p = \vek{0}\).
