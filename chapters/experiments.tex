...
Aditionally, \cref{table:accuracy_comparison} demonstrates that the direct approach generates more accurate solutions as the iterative approach can.
...
The quality of the linear solver for the normal equation directly affects the solution accuracy of the IPM algorithm as a whole so that the time-accuracy tradeoff of the iterative solver can be directly transferred to a time-accuracy tradeoff for the IPM algorithm.
